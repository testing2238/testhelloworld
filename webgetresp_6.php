...
$conn = pg_connect("host=fanny.db.elephantsql.com user=yhogiwqd password=fP8TeH5OdWLxIQXfw1EDDLkfSK0ysov2 dbname=yhogiwqd");
//$conn = pg_connect("host=fanny.db.elephantsql.com port=5432 user=yhogiwqd password=fP8TeH5OdWLxIQXfw1EDDLkfSK0ysov2 dbname=yhogiwqd");
if ($conn) {
