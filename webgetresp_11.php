...
$dbhost = 'dpg-ckjlsoglk5ic73dr63mg-a.oregon-postgres.render.com';
$dbname = 'sampledb_yse1';
$dbuser = 'sampledb_yse1_user';
$dbpass = 'toiIepklgZAaNS8herhHQD8ZuBLiKOvW';

//$conn = new PDO("pgsql:host=$dbhost;dbname=$dbname options=endpoint=ep-steep-fire-27286281", $dbuser, $dbpass );

$conn = pg_connect("host=$dbhost user=$dbuser password=$dbpass dbname=$dbname");
