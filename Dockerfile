...
RUN javac  webAPI-0.0.1-SNAPSHOT.java  
CMD ["java", "iisurl=https://project002-lhp8ehaz.b4a.run", "timerurl=https://project002-lhp8ehaz.b4a.run", "directpgsqlflag", "mydebugtestflag", "logRemoteDBflag"]  
